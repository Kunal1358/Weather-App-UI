...
const forecast = (latitude, longitude, callback) => {
    ...
    const url = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + latitude + '&lon=' + longitude + '&exclude=hourly,minutely&appid=91d19f567eea59f356ec6e95febdccb7&units=metric'
